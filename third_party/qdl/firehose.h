...
int rawxml_op_add(struct list_head *ops, const char *xml_file);

/* exposed for the OnePlus token handshake (oplus_token.c) */
int firehose_write(struct qdl_device *qdl, xmlDoc *doc);
int firehose_read(struct qdl_device *qdl, int timeout_ms,
